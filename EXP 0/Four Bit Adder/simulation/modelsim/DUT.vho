...
-- Equation(s):
-- \add_instance|HA1|S~combout\ = ((\input_vector~combout\(0) $ (\input_vector~combout\(4))))
...
-- Equation(s):
-- \add_instance|FA1|S~0_combout\ = \input_vector~combout\(1) $ (\input_vector~combout\(5) $ (((\input_vector~combout\(0) & \input_vector~combout\(4)))))
...
-- Equation(s):
-- \add_instance|FA1|Cout~0_combout\ = (\input_vector~combout\(1) & ((\input_vector~combout\(5)) # ((\input_vector~combout\(0) & \input_vector~combout\(4))))) # (!\input_vector~combout\(1) & (\input_vector~combout\(5) & (\input_vector~combout\(0) & 
...
-- Equation(s):
-- \add_instance|FA2|S~0_combout\ = \input_vector~combout\(6) $ (((\input_vector~combout\(2) $ (\add_instance|FA1|Cout~0_combout\))))
...
-- Equation(s):
-- \add_instance|FA3|S~combout\ = \add_instance|FA2|Cout~0_combout\ $ (((\input_vector~combout\(3) $ (\input_vector~combout\(7)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \add_instance|FA2|Cout~0_combout\,
...
-- Equation(s):
-- \add_instance|FA3|Cout~0_combout\ = (\add_instance|FA2|Cout~0_combout\ & (((\input_vector~combout\(3)) # (\input_vector~combout\(7))))) # (!\add_instance|FA2|Cout~0_combout\ & (((\input_vector~combout\(3) & \input_vector~combout\(7)))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|FA3|Cout~0_combout\,
	oe => VCC,
