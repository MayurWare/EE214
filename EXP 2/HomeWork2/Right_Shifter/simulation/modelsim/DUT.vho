...
-- Equation(s):
-- \add_instance|Y[0]~0_combout\ = (\input_vector~combout\(8) & (((\input_vector~combout\(1))))) # (!\input_vector~combout\(8) & (\input_vector~combout\(0)))
...
-- Equation(s):
-- \add_instance|Y[1]~1_combout\ = (\input_vector~combout\(8) & (\input_vector~combout\(2))) # (!\input_vector~combout\(8) & (((\input_vector~combout\(1)))))
...
-- Equation(s):
-- \add_instance|Y[2]~2_combout\ = (\input_vector~combout\(8) & (((\input_vector~combout\(3))))) # (!\input_vector~combout\(8) & (\input_vector~combout\(2)))
...
-- Equation(s):
-- \add_instance|Y[3]~3_combout\ = ((\input_vector~combout\(8) & ((\input_vector~combout\(4)))) # (!\input_vector~combout\(8) & (\input_vector~combout\(3))))
...
-- Equation(s):
-- \add_instance|Y[4]~4_combout\ = (\input_vector~combout\(8) & (\input_vector~combout\(5))) # (!\input_vector~combout\(8) & (((\input_vector~combout\(4)))))
...
-- Equation(s):
-- \add_instance|Y[5]~5_combout\ = (\input_vector~combout\(8) & (((\input_vector~combout\(6))))) # (!\input_vector~combout\(8) & (\input_vector~combout\(5)))
...
-- Equation(s):
-- \add_instance|Y[6]~6_combout\ = ((\input_vector~combout\(8) & (\input_vector~combout\(7))) # (!\input_vector~combout\(8) & ((\input_vector~combout\(6)))))
